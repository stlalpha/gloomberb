...
export const newsWirePlugin: GloomPlugin = {
  ...
  name: "News Wire",
  version: "1.0.0",
  description: "Market-wide news aggregation from RSS feeds",
  toggleable: true,
  ...
  setup(ctx) {
    ...
    ctx.registerPane({ id: "news-industry", name: "Industry News", icon: "I", component: IndustryPane, defaultPosition: "right", defaultMode: "floating", defaultFloatingSize: { width: 100, height: 35 } });
